...
export default function Hero() {
  return (
    <section className="w-full h-full bg-stone-950 flex flex-col md:flex-row overflow-x-hidden">
      {/* Left / Image */}
      <div className="w-full md:w-1/3 relative flex justify-center items-center">
        ...
        <div className="flex md:hidden absolute bottom-10 left-1/2 transform -translate-x-1/2 space-x-4">
          <button className="px-4 py-2 bg-white text-stone-950 font-bold rounded">
            Contact
          </button>
          <button className=" px-4 py-2 bg-white text-stone-950 font-bold rounded">
            Portfolio
        ...
        <h1
          id="hero-name"
          className="absolute md:hidden bottom-32 text-5xl font-medium tracking-widest text-white text-center drop-shadow-lg"
        >
          Bianka Halmai
        </h1>
        <p className="absolute md:hidden bottom-27 text-white text-md tracking-widest drop-shadow-2xl">
      ...
      <div className="hidden md:flex w-2/3 justify-center items-center flex-col space-y-8">
        <h1
          id="hero-name-lg"
          className="text-6xl lg:text-8xl font-medium tracking-wider text-white text-center"
        >
          Bianka Halmai
        </h1>
